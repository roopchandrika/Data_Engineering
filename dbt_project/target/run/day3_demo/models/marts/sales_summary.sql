  ...
  create or replace   view DAY3_DEMO.ANALYTICS.sales_summary
  
   as (
    

with f as (
  select * from DAY3_DEMO.ANALYTICS.fact_orders
),
c as (
  select * from DAY3_DEMO.ANALYTICS.dim_customers  -- current version only
),
p as (
